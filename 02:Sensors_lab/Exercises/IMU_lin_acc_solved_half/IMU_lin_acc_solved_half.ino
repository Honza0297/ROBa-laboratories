// Filename: IMU_ang_lin_acc_solved_half.ino
// Author: Adam Fabo
// Last edit: 24.4.2023
...
// Description: File contains half-finished code that measures linear acceleration of IMU
...
void setup() {
  ...
  **********************************************/
  ...
  Wire.beginTransmission(IMU_gyroscope_address); // IMU adress
...
int get_linear_acceleration(byte low_address, byte high_address){
  ...
  Reading data from MinIMU
    ...
    - Request data from gyroscope using Wire.requestFrom(address, bytes) function where address is sonar addres and bytes is number
...
double acc_2_G(int acceleration){
  ...
  **********************************************/
  ...
  double constant = 1.0;          // rough constant
