// Filename: IMU_ang_lin_acc_solved_full.ino
// Author: Adam Fabo
// Last edit: 24.4.2023
...
// Description: File contains finished code that measures linear acceleration of IMU
...
double acc_2_G(int acceleration){
  ...
  **********************************************/
  ...
  double constant = 2000.0;          // rough constant
