// Filename: IMU_ang_rate_solved.ino
// Author: Adam Fabo
// Last edit: 24.4.2023
...
// Description: File contains finished code that measures angular rate of IMU
...
void loop() {
  ...
  Serial.print("Ang_rate_X:"); Serial.print(ang_x); Serial.print(" , ");
  Serial.print("Ang_rate_Y:"); Serial.print(ang_y); Serial.print(" , ");
  Serial.print("Ang_rate_Z:"); Serial.println(ang_z);
