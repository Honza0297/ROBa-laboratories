// Filename: IMU_temperature_solved.ino
// Author: Adam Fabo
// Last edit: 24.4.2023
...
// Description: File contains finished code that reads temperature data from IMU
...
// Value that says how fast should be the measurements taken 
...
void setup() {
  ...
  // For temperature sensor there is need to setup the gyroscope   
