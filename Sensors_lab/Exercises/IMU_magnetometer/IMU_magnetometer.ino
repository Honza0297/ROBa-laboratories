...
// Description: File contains unfinished code that reads magnetometer data from IMU
...
void loop() {
  ...
  Serial.print("Strength_of_mag_field_X:"); Serial.print(mag_x); Serial.print(" , ");
  Serial.print("Strength_of_mag_field_Y:"); Serial.print(mag_y); Serial.print(" , ");
  Serial.print("Strength_of_mag_field_Z:"); Serial.println(mag_z);
